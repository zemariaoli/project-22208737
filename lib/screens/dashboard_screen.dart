...
class DashboardScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final totalIncidents = stations.fold(0, (acc, s) => acc + s.reports.length);
    final mediaGeral = totalIncidents > 0
        ? (stations.fold(0.0, (acc, s) {
      final total = s.reports.fold(0.0, (sum, r) => sum + r.rate);
      return acc + total;
    }) / totalIncidents)
        : 0.0;
          ...
          children: [
            ...
            if (stationDestaque != null)
              Card(
                ...
                child: ListTile(
                  leading: const Icon(Icons.train, size: 40, color: Colors.blueGrey),
            ...
            Card(
              ...
              child: Padding(
                ...
                child: Row(
                  children: const [
                    Icon(Icons.info_outline, size: 32, color: Colors.deepPurple),
                    SizedBox(width: 12),
                    Expanded(
                      child: Text(
